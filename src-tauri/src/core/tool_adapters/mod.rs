...
pub enum ToolId {
    Agents, // Special priority adapter for ~/.agents/skills
    AoneCopilot, // Aone Copilot skills directory
    Cursor,
    ClaudeCode,
    Codex,
    OpenCode,
...
impl ToolId {
    pub fn as_key(&self) -> &'static str {
        match self {
            ...
            ToolId::AoneCopilot => "aone_copilot",
...
pub fn default_tool_adapters() -> Vec<ToolAdapter> {
    vec![
        // Priority adapter for ~/.agents/skills - should be scanned first
        ToolAdapter {
            id: ToolId::Agents,
            display_name: "Agents (Priority)",
            relative_skills_dir: ".agents/skills",
            relative_detect_dir: ".agents",
        },
        // Aone Copilot skills directory
        ToolAdapter {
            id: ToolId::AoneCopilot,
            display_name: "Aone Copilot",
            relative_skills_dir: ".aone_copilot/skills",
            relative_detect_dir: ".aone_copilot",
        },
        ToolAdapter {
            id: ToolId::Cursor,
            display_name: "Cursor",
